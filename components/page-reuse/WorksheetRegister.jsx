...
export default function Index(props) {
  ...
  return (
    <div>
                ...
                <div className="flex items-center gap-1 mb-1" key={salaryTimesheet.date}>
                  ...
                  {salaryTimesheet.timesheetData.map(timesheetCell => (
                    <div
                      ...
                      className={`${timesheetCell.isSelected === true ? 'bg-blue-200 hover:bg-red-400' : 'bg-gray-100 hover:bg-blue-200'} ${timesheetCell.isPicked === true ? '!bg-gray-300 !hover:bg-gray-100' : 'hover:cursor-pointer'} w-12 h-8 flex items-center relative justify-center font-sm font-semibold text-center grow`}
      ...
      <div className="border rounded shadow bg-white p-2 mt-1">
